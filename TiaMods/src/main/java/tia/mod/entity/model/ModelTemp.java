...
public class ModelTemp extends ModelBase {
    ...
    public ModelTemp() {
        ...
        this.backrightfoot.setRotationPoint(-2.5F, 16.0F, 7.0F);
        this.backrightfoot.addBox(0.0F, 0.0F, -1.0F, 2, 8, 2, 0.0F);
        this.bodyfur = new ModelRenderer(this, 21, 0);
        this.bodyfur.setRotationPoint(-1.0F, 14.0F, -3.0F);
